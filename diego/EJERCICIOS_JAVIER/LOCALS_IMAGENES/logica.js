...
function crearHTML() {
    limpiar();
        ...
        Imagenes.forEach((imgn) => {
            ...
            // Celda de punto de salida
            const celdaLLegada = row.insertCell(1);
            celdaLLegada.textContent = imgn.a;
            
            // Celda de punto de llegada
            const celdaSalida = row.insertCell(2);
            celdaSalida.textContent = imgn.b;
            
            // Celda de nombre del menor
            const celdaNombre = row.insertCell(3);
            celdaNombre.textContent = imgn.nombre;
    ...
    //     nm.innerHTML = `<h4>Nombre: </h4><p>${imgn.a}</p>`;
