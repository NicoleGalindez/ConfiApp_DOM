...
let cuadrito6= document.getElementById('cuadrito6');
let cuadrito7= document.getElementById('cuadrito7');
let cuadrito8= document.getElementById('cuadrito8');
let cuadrito9= document.getElementById('cuadrito9');
let cuadrito10= document.getElementById('cuadrito10');
let cuadrito11= document.getElementById('cuadrito11');
let cuadrito12= document.getElementById('cuadrito12');
...
let decide = parseInt(prompt("¿Me recuerdas el rol qué ocupas? : 1  Tutor, 2  Menor ó 3  modo invitado "));
       ...
       if(decide===1){
            ...
            cuadrito1.innerText=`Visita`;
            cuadrito2.innerText=`Estadisticas`;
            cuadrito3.innerText=`Asignar fecha`;
            cuadrito4.innerText=`Crear ruta`;
            cuadrito5.innerText=`Paradas frecuentes`;
            cuadrito6.innerText=`Sin avisos`;
            // cuadrito7.innerText=``;
            cuadrito8.innerText=`Casita`;
            cuadrito9.innerText=`Ancla`;
            cuadrito10.innerText=`Musica?`;
            cuadrito11.innerText=`Visita`;
            cuadrito11.innerText=`Visita`;
        ...
        // _______MENOR______________________________________________________________________
            ...
            titcuadroverdemen.innerText=`¿Quieres saber un poco mas sobre nosotros ? `;
            ...
            cuadrito1.innerText=`markyellow`;
            cuadrito2.innerText=`azulito`;
            cuadrito3.innerText=`Calendario`;
            //cuadrito4.innerText=`Crear ruta`;
            cuadrito4.remove('Magni Dolores');
            cuadrito5.innerText=`Paradas `;
            cuadrito6.innerText=`Todos los avisos`;
            // cuadrito7.innerText=``;
            cuadrito8.innerText=`Casa`;
            cuadrito9.innerText=`Baaaa`;
            cuadrito10.innerText=`listen`;
            cuadrito11.innerText=`Ubicacion actual`;
            cuadrito11.innerText=`Visita`;
